...
def run_test(dataset_name, dir_name, file_prefix, chan):
    print(f"\n=========================================")
    print(f"TRAINING 40 EPOCHS: {dataset_name} ({chan})")
    print(f"=========================================")
    ...
    for clip in [20.0, 500.0]:
        ...
        for th in candidates:
            ...
            best_pa_f1 = max(best_pa_f1, m_pa.get('f1', 0.0))
            best_std_f1 = max(best_std_f1, m_std.get('f1', 0.0))
            
        print(f"Clip: {clip:5.1f} | Unsub PA F1: {m_unsub_pa.get('f1', 0.0):.4f} | Oracle Std F1: {best_std_f1:.4f} | Oracle PA F1: {best_pa_f1:.4f}")

if __name__ == "__main__":
    run_test("metro", "metro", "metro_traffic-volume", "")
