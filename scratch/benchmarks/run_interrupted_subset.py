...
def main():
    ...
    print(f"Running {len(notebooks)} remaining notebooks concurrently...", flush=True)
    ...
    print(f"All remaining notebooks finished in {time.time() - start_total:.2f}s.", flush=True)
