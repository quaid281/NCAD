...
for rpca_flag in [False, True]:
    print(f"\n=================== EVALUATING RPCA SANITIZATION = {rpca_flag} ===================")
    memory = CounterfactualSuccessorMemory(
        SuccessorMemoryConfig(n_neighbors=8, max_memory_windows=5000, context_percentile=99.0, seed=42, use_rpca_sanitization=rpca_flag)
    )
